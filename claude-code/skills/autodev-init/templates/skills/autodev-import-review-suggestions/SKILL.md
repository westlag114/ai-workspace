---
name: autodev-import-review-suggestions
...
allowed-tools: Read, Write, Edit, MultiEdit, "Bash(cd * && gh pr view *)", "Bash(git -C * add *)", "Bash(git -C * commit *)", "Bash(git -C * push *)", mcp__github__pull_request_read, mcp__github__add_reply_to_pull_request_comment
---
